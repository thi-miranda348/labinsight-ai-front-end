...
import { Bell, Search, UserCircle, X, Settings, LogOut, User as UserIcon } from "lucide-react";
                ...
                <div className="flex items-center gap-2 md:gap-4 lg:gap-6 ml-auto">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="icon" className="relative rounded-full border-none">
                        ...
                        <DropdownMenuContent align="end" className="w-64">
                            ...
                            <DropdownMenuItem className="flex flex-col items-start gap-1 p-3 cursor-pointer">
                                <span className="font-medium text-sm">Critical Report Alert</span>
                                <span className="text-xs text-muted-foreground">Patient Arthur J. Thompson requires immediate review.</span>
                            </DropdownMenuItem>
                            <DropdownMenuSeparator />
                            <DropdownMenuItem className="flex flex-col items-start gap-1 p-3 cursor-pointer">
                                <span className="font-medium text-sm">AI Engine Update</span>
                                <span className="text-xs text-muted-foreground">System v4.2 is now online.</span>
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
                    ...
                    <div className="border-l pl-2 md:pl-4 flex h-8 items-center">
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" className="flex items-center gap-2 lg:gap-3 px-2 hover:bg-muted h-12 border-none">
                                    ...
                                    <div className="hidden md:flex md:flex-col items-start text-left">
                                        ...
                                        <p className="text-[10px] text-muted-foreground mt-1 tracking-wider uppercase">Clinical Pathologist</p>
                                    </div>
                                </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent align="end" className="w-56 mt-2">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem className="text-destructive cursor-pointer hover:text-destructive hover:bg-destructive/10">
